...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // Flag to indicate if data exists
        bool dataExists = false;
        bool dataExists2 = false;
                        ...
                        while (!exitRequested)
                        {
                            ...
                            switch (choice)
                            {
                                ...
                                case 2:
                                    ...
                                    {
                                        Console.WriteLine("Please enter the recipient account: ");
                                        ...
                                        using (SQLiteDataReader reader = command4.ExecuteReader())
                                        {
                                            if (reader.Read())
                                            {
                                               ...
                                               string currentBalance = reader["Balance"].ToString();
                                                ...
                                                {
                                                    // Conversion failed
                                                    Console.WriteLine("Failed to convert Balance value to double.");
                                                }
                                            }
                                        }
                                    }
